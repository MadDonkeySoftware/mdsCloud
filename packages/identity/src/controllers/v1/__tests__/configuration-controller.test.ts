...
describe('configurationController test', () => {
  ...
  describe('getConfiguration', () => {
    it('Loads the configuration from the data store and returns it - internal', async () => {
      // Arrange
    ...
    it('Loads the configuration from the data store and returns it - external', async () => {
      // Arrange
      const mockGetConfig = jest.fn().mockImplementation(() =>
        Promise.resolve({
          internal: {
    ...
    it('Returns a 422 when no configuration is found', async () => {
      // Arrange
      const mockGetConfig = jest.fn().mockImplementation(() =>
